...
@Component({
  selector: 'app-ant-mobi',
  templateUrl: './ant-mobi.component.html',
  styleUrls: ['./ant-mobi.component.scss'],

})
export class AntMobiComponent implements OnInit {
  ...
  getAntData() {
    ...
    this.antService.fetchAntData(data).subscribe((response) => {
      ...
      this.antMobiData = response[0] == 'No Data'?[]:response;
      setTimeout(() => {
