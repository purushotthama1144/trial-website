...
@Component({
  selector: 'app-ekyc-guidelines',
  templateUrl: './ekyc-guidelines.component.html',
  styleUrls: ['./ekyc-guidelines.component.scss'],
  
})
export class EkycGuidelinesComponent implements OnInit {
  pageloader:boolean = true
  steps: any[] = [
    `Visit this <a target="_blank" rel="noreferrer" href="https://aliceblueonline.com/open-account-fill-kyc-request-call-back">link</a>, fill in the basic information and click on Open an Account.` , 
    `Add Contact and Bank Details.` , 
    `Add Financial and Personal Details.` , 
    `E-sign your documents with Aadhar and your Demat Account will be activated within 24 hours.`
  ]

  url = this.router.url;
  popup : any;
  constructor( private router: Router , private meta: Meta, private seoService: SeoService, private title: Title , public dialog: MatDialog , private popupservice: PopupService) { }
