...
@Component({
  selector: 'app-bo-co-margin',
  templateUrl: './bo-co-margin.component.html',
  styleUrls: ['./bo-co-margin.component.scss'],
  
})
export class BoCoMarginComponent implements OnInit {
 bocomargin : any;
  ...
  getBocoData() {
    const data = {
      "rms_calculator_type" : "BO CO Margin"
    }
    this.rmsService.getRmsliveData(data)
      .subscribe((response: any) => {
        
        this.bocomargin = response
      }, (error) => {
