...
@Component({
  selector: 'app-ban-symbol',
  templateUrl: './ban-symbol.component.html',
  styleUrls: ['./ban-symbol.component.scss'],
  
})
export class BanSymbolComponent implements OnInit {
  bansymbol : any;
  ...
  getBanSymbolData() {
    const data = {
      "rms_calculator_type" : "Ban Symbols"
    }
    this.rmsService.getRmsliveData(data)
      .subscribe((response: any) => {
        
        this.bansymbol = response
      }, (error) => {
