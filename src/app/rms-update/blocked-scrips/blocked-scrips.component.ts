...
@Component({
  selector: 'app-blocked-scrips',
  templateUrl: './blocked-scrips.component.html',
  styleUrls: ['./blocked-scrips.component.scss'],
  
})
export class BlockedScripsComponent implements OnInit {
  ...
  getBocoData() {
    const data = {
      "rms_calculator_type" : "Blocked Script"
    }
    this.rmsService.getRmsliveData(data)
      .subscribe((response: any) => {
       
        this.blockedscrip = response
      }, (error) => {
