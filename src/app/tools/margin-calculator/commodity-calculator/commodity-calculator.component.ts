...
@Component({
  selector: 'app-commodity-calculator',
  templateUrl: './commodity-calculator.component.html',
  styleUrls: ['./commodity-calculator.component.scss'],
  
})

export class CommodityCalculatorComponent implements OnInit {
  
  exposure = 2;

  pageloader:boolean = false;

  fileName= 'brokerage-commodity.xlsx';

  calculatorData : any [] = [];
  downloadExcel : any [] = [];

  imgrtxtlcommodity = {
    image: "https://alicewebsite.s3.ap-south-1.amazonaws.com/website/img-v2/commodity.png",
    alt:"Commodity margin calculator",
    content: "It is an online tool to calculate the minimum money or margin required to trade Commodity futures contracts like CRUDEOIL, ALUMINIUM, COPPER, GOLD etc.",
  ...
  // activeState: boolean[] = new Array(this.accordion.length);
