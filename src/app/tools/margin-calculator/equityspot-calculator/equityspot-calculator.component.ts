...
@Component({
  selector: 'app-equityspot-calculator',
  templateUrl: './equityspot-calculator.component.html',
  styleUrls: ['./equityspot-calculator.component.scss'],
  
})
export class EquityspotCalculatorComponent implements OnInit {
  fileName = 'equity-spot.xlsx';  
  accordion: any[] = []
  ...
  imgrtxtlcommodity = {
    image: "https://alicewebsite.s3.ap-south-1.amazonaws.com/website/img-v2/equity.png",
    alt:"Equity Margin Calculator",
    content: "It is an online tool to calculate the minimum money or margin required to trade Equity Spot like INFY, ACC, WIPRO, TVSMOTOR etc.",
  ...
  displayedColumns: string[] = ['number', 'scrip', 'mismultiplier', 'cncmultiplier' ];
  dataSource: MatTableDataSource<any> = new MatTableDataSource(this.calculatorData);
