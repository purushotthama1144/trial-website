...
export class OpenAccountComponent implements OnInit {
  ...
  awards = [
    ...
    {
      awards_title:"Top 3 contributors in Equity Derivatives",
      alt:"Top 3 contributors in Equity Derivatives",
      awards_image_path:"https://alicewebsite.s3.ap-south-1.amazonaws.com/website/img-v2/NSE-Award-New.webp",
      awards_description:" Top 3 contributors in Equity Derivatives- In south Region by NSE in 2021"
    },
  ]
  ...
  getSeoData() {
    this.seoService.createCanonicalURL();
    this.meta.addTags([
      // { name: 'title' , content : 'Open Demat Account | Alice Blue' },
      { property: 'og:title' , content : 'Open Demat Account | Alice Blue' },
      { name: 'description' , content : 'Click here to sign up for a free Demat and Trading Account with Alice Blue. Simply fill out the form and our KYC experts will contact you to assist you.' },
      { property: 'og:description', content: 'Click here to sign up for a free Demat and Trading Account with Alice Blue. Simply fill out the form and our KYC experts will contact you to assist you.' },
    ...
    this.title.setTitle("Open Demat Account | Alice Blue");
  }
